package be.civadis.wf.repository;

import be.civadis.wf.WfApp;
import be.civadis.wf.config.Constants;
import be.civadis.wf.config.audit.AuditEventConverter;
import be.civadis.wf.domain.PersistentAuditEvent;
...
import static be.civadis.wf.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
