...
import be.civadis.wf.web.rest.errors.ExceptionTranslator;
import be.civadis.wf.web.rest.workflow.EngineFacadeResource;
...
import static be.civadis.wf.web.rest.TestUtil.createFormattingConversionService;
...
public class EngineFacadeResourceTest {
    ...
    public void setup() {
        ...
        final EngineFacadeResource engineFacadeResource = new EngineFacadeResource(engineFacade);
    ...
    public void testProcessByAdmin() throws Exception {
        ...
        ProcessInstanceDto processInstance = mapper.readValue(resPr.getResponse().getContentAsString(), ProcessInstanceDto.class);
